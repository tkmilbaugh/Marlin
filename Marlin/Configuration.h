...
#define STRING_CONFIG_H_AUTHOR "tkm 2021-11-24" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "E3Pro CR-Touch"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -47, -9, -1.1 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT ((X_BED_SIZE - 10) / 3)    // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT ((Y_BED_SIZE - 10) / 3)    // Y point for Z homing
#endif
